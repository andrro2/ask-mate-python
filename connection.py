...
DATA_FILE_PATH_QUESTION = os.getenv('DATA_FILE_PATH') if 'DATA_FILE_PATH' in os.environ else 'question.csv'
...
def get_csv_data(one_user_story_id=None):
    ...
    with open(DATA_FILE_PATH_QUESTION encoding='utf-8') as csvfile:
